  ...
  return (
    <>
      <div className="w-[558px] flex justify-between items-center">
        <label className="text-[24px] mr-[14px] text-primary-cheese">
          {label}
        </label>
        <input
      ...
      <p className="w-full ml-[144px] pl-[30px] py-[15px] text-error text-[14px]">
        {error}
      </p>
      <p className="w-full ml-[144px] pl-[30px] py-[15px] text-access text-[14px]">
        {access}
      </p>
    </>
  );
