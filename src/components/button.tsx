...
const ChapButton: FC<ButtonTypes> = ({
  ...
  const variantCSS = {
    cheese:
      "bg-primary-cheese shadow-dropCheese hover:shadow-innerCheese focus:shadow-innerCheese",
    peanut:
      "bg-primary-peanut shadow-dropPeanut hover:shadow-innerPeanut focus:shadow-innerPeanut",
    noResults:
