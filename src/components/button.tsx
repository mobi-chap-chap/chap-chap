...
const ChapButton: FC<ButtonTypes> = ({
  ...
  const variantCSS = {
    cheese:
      "bg-primary-cheese text-primary-peanut shadow-dropCheese hover:shadow-innerCheese focus:shadow-innerCheese",
    peanut:
      "bg-primary-peanut shadow-dropPeanut hover:shadow-innerPeanut focus:shadow-innerPeanut text-primary-cheese",
    noResults:
      "bg-primary-peanut hover:bg-primary-cheese text-primary-cheese hover:text-primary-peanut",
  };
  const sizeCSS = {
