...
const RecipeList: FC = () => {
  const { recipeData, fetchNextPage, isLoading } = useGetRecipeInfinity();
  ...
  if (!isLoading) return <Lottie options={defaultOptions} height={260} width={260} style={{marginBlock : '70px'}} />
